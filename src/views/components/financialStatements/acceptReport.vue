<template>
  <div class="diaplayinformation">
    <el-card class="box-card">
        ...
        <el-form-item label="平台" prop="platom">
            <el-select v-model="form.platom" placeholder="请选择">
            <el-option
                v-for="(item, index) in platomList"
                :key="index"
                :label="item.platom"
                :value="item.platom"
            ></el-option>
    ...
    >
      ...
      <el-table-column prop="platom" label="平台" width="150" align="center"></el-table-column>
      <el-table-column prop="effect" label="生效规则" align="center"></el-table-column>
      <el-table-column prop="accepted_at" label="受理时间" width="100" align="center"></el-table-column>
      <el-table-column prop="count" label="单量" align="center"></el-table-column>
      <el-table-column prop="unit_price" label="结算单价" align="center"></el-table-column>
      <el-table-column prop="type" label="结算类型" align="center"></el-table-column>
      <el-table-column v-for="(item, index) in detailList" :key="index" :prop="'t'+(index+1)+'_price'" :label="'T'+(index+1)+'结算'" width="100" align="center"></el-table-column>
      <el-table-column prop="total_price" label="总金额" width="150" align="center"></el-table-column>
    </el-table>
...
export default {
  ...
  methods: {
    ...
    search() {
      ...
      report.acceptanceList(this.form).then(
          res => {
            if (res.code == 200) {
    ...
    dao() {
      ...
      window.location.href =
        "/settlement/public/index.php/api/report/acceptanceExport?name=" +
        this.form.name +
        "&city=" +
        this.form.city +
        "&platom=" +
